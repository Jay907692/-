game:GetService("StarterGui"):SetCore("SendNotification", { 
	...
	Icon = "skull";
Duration = 15})
local key = "泽NBjaycltynb" 

local keylink = "群号130704237" 

local nameofthescript = "泽脚本"

local whoisitmadeby = "泽少NB" 

local thenoteofthekey = "群号130704237" 
...
TextButton.MouseButton1Click:Connect(function()
	if KeyTextbox.Text == key then
		TextButton.Text = "正确!"
		task.wait(2)
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Jay907692/-/86c098a230247e34ccd0b9a060859aa9037b49ca/%E6%B3%BD%E8%84%9A%E6%9C%AC%E5%8A%A0%E8%BD%BD%E5%99%A8"))() -- insert script on this line
		ScreenGui:Destroy()
	else
